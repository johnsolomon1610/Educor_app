package com.example.educor_app.quiz.Create_Quiz;
...
//                                         result.setText(userInput.getText());
                                                final Map<String, Object> result = new Gson().fromJson(jsonStr, Map.class);
                                                fileName = userInput.getText().toString().trim();
                                                if (!TextUtils.isEmpty(fileName)) {

                                                    databaseReference=FirebaseDatabase.getInstance().getReference("Class").child("Create");
                                                    databaseReference.addValueEventListener(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                            ...
                                                            for(DataSnapshot df:snapshot.getChildren()){
                                                                ...
                                                                String userid=df.child("UserId").getValue().toString();

                                                                if(userid.equals(user.getUid())){
                                                                    String class_name=df.child("Name").getValue().toString();

                                                                    myRef.child("Quiz").child(class_name).child("tests").child(fileName).setValue(result);
                                                                    Toast.makeText(Custom_quiz.this, "success", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        }
